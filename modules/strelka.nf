process strelka{
    ...
    python2.7 StrelkaSomaticWorkflow/runWorkflow.py -m local -j ${task.cpus} -g 40


    mv StrelkaSomaticWorkflow/results/variants/somatic.indels.vcf.gz ${sample_name}.strelka.indels.vcf.gz 
    mv StrelkaSomaticWorkflow/results/variants/somatic.snvs.vcf.gz ${sample_name}.strelka.indels.vcf.gz 
    mv StrelkaSomaticWorkflow/results/variants/somatic.indels.vcf.gz.tbi ${sample_name}.strelka.indels.vcf.gz.tbi 
    mv StrelkaSomaticWorkflow/results/variants/somatic.snvs.vcf.gz.tbi ${sample_name}.strelka.indels.vcf.gz.tbi 
